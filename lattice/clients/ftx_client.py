...
"""
clone of https://github.com/ftexchange/ftx
"""
...
class FtxClient:
    ...
    def _request(self, method: str, path: str, **kwargs) -> Any:
        ...
        prepared = self._sign_request(request)
    ...
    def get_trades(
        ...
        return self._get(
            f"markets/{market}/trades", {"start_time": start_time, "end_time": end_time}
        )
    ...
    def get_all_trades(
        ...
        while True:
            ...
            if len(response) == 0:
                break
            end_time = min(isoparse(t["time"]) for t in response).timestamp()
    ...
    def get_historical_prices(
        ...
        return self._get(
            ...
            {"resolution": resolution, "start_time": start_time, "end_time": end_time},
        )

    def get_last_historical_prices(
        self, market: str, resolution: int = 300
    ) -> List[dict]:
    ...
    def get_trigger_order_triggers(
        self, conditional_order_id: str = None
    ) -> List[dict]:
    ...
    def get_staking_rewards(
        ...
        return self._get(
            "staking/staking_rewards", {"start_time": start_time, "end_time": end_time}
        )
    ...
    def get_funding_rates(
        self, future: str = None, start_time: float = None, end_time: float = None
    ) -> List[dict]:
        return self._get(
            "funding_rates",
            {"future": future, "start_time": start_time, "end_time": end_time},
        )
    ...
    def get_funding_payments(
        ...
        return self._get(
            "funding_payments", {"start_time": start_time, "end_time": end_time}
        )
    ...
    def get_withdrawal_fee(
        self, coin: str, size: int, address: str, method: str = None, tag: str = None
    ) -> Dict:
        return self._get(
    ...
    def submit_fiat_withdrawal(
        self, coin: str, size: int, saved_address_id: int, code: int = None
    ) -> Dict:
        return self._post(
            "wallet/fiat_withdrawals",
            {
                "coin": coin,
                "size": size,
    ...
    def get_latency_stats(self, days: int = 1, subaccount_nickname: str = None) -> Dict:
        return self._get(
            "stats/latency_stats",
            {"days": days, "subaccount_nickname": subaccount_nickname},
        )
