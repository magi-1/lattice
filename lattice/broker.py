...
class FTXBroker(Broker):
    ...
    def market_order(self, market: str, side: str, size: float) -> LocalMarketOrder:
    ...
    def limit_order(
        self, market: str, side: str, size: float, open_price: float
    ) -> LocalMarketOrder:
        return FTXLimitOrder(market=market, side=side, size=size, open_price=open_price)
